...
public class UserController {
	...
	public ResponseEntity<String> validateUser(@PathVariable("id") int id, @RequestParam("name") String name, @RequestParam("password") String password) throws UserNotFoundException{
		if(userService.validateUser(id, name, password)) {
