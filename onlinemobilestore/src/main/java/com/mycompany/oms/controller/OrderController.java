...
public class OrderController {
		...
		public ResponseEntity<Order> updateStatus(@PathVariable("id") int id, @PathVariable("date") LocalDate date) throws OrderNotFoundException{
			return new ResponseEntity<>(orderService.updateDispatchDate(id, date), HttpStatus.OK);
		}
